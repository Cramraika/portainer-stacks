...
- **Currently live:** `stacks/immich/` + `stacks/uptime-kuma/` (Git-backed on `vagary-core-1`; immich stack id 17 — ids drift on recreate, see playbook §7 expected-output). (Reconciled 2026-06-07.)
